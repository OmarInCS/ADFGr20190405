...
public class EmployeesEOImpl extends EntityImpl {
    ...
    public static final int EMPIMPORTDETAIL = AttributesEnum.EmpImportDetail.index();
     ...
     * @return the associated entity oracle.jbo.server.EntityImpl.
     */
    public EntityImpl getEmpImportDetail() {
        return (EntityImpl) getAttributeInternal(EMPIMPORTDETAIL);
    }

    /**
     * Sets <code>value</code> as the associated entity oracle.jbo.server.EntityImpl.
     */
    public void setEmpImportDetail(EntityImpl value) {
        setAttributeInternal(EMPIMPORTDETAIL, value);
    }
